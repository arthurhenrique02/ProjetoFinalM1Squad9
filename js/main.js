...
function mostrarPergunta(perguntas, indicePerguntaAtual, elementoPergunta, botoesResposta) {
    ...
    perguntaAtual.respostas.forEach(resposta => {
        ...
        botao.addEventListener("click", (e) => selecionarResposta(e, botoesResposta, botaoProximo));
    });
}